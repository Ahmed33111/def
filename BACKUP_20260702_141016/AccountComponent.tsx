            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                ...
                <div className="flex items-center gap-1.5 mt-2">
                  ...
                  <span className="text-xs text-red-600 font-medium">Débits cumulés</span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {accounts.map(account => (
                ...
                >
                  ...
                  <h3 className="text-sm font-semibold text-gray-800">{account.user?.fullName}</h3>
                        ...
                        <div className={`p-5 ${card.blocked ? 'bg-gradient-to-br from-gray-600 to-gray-700' : 'bg-gradient-to-br from-gray-800 to-gray-900'}`}>
                          ...
                          <div className="flex justify-between items-end">
                            <div>
                              ...
                              <p className="text-sm font-semibold text-white">{card.holderName || selectedAccount.user?.fullName}</p>
                            </div>
